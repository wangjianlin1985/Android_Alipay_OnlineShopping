...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>登录密码:</td>
    <td width=70%><input id="memberInfo.password" name="memberInfo.password" type="password" size="20" /></td>
  </tr>
  ...
  <tr>
    <td width=30%>性别:</td>
    <td width=70%><select id="memberInfo.sex" name="memberInfo.sex">
