	...
	public void onCreate(Bundle savedInstanceState) {
		...
		iv_photo.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(MemberRegisterActivity.this,photoListActivity.class);
			...
			public void onClick(View v) {
				try {
					...
					if(ET_memberUserName.getText().toString().equals("")) {
						Toast.makeText(MemberRegisterActivity.this, "会员用户名输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_password.getText().toString().equals("")) {
						Toast.makeText(MemberRegisterActivity.this, "登录密码输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_realName.getText().toString().equals("")) {
						Toast.makeText(MemberRegisterActivity.this, "真实姓名输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_sex.getText().toString().equals("")) {
						Toast.makeText(MemberRegisterActivity.this, "性别输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_telephone.getText().toString().equals("")) {
						Toast.makeText(MemberRegisterActivity.this, "联系电话输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_email.getText().toString().equals("")) {
						Toast.makeText(MemberRegisterActivity.this, "联系邮箱输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_qq.getText().toString().equals("")) {
						Toast.makeText(MemberRegisterActivity.this, "联系qq输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_address.getText().toString().equals("")) {
						Toast.makeText(MemberRegisterActivity.this, "家庭地址输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(memberInfo.getPhoto() != null) {
						...
						MemberRegisterActivity.this.setTitle("正在上传图片，稍等...");
						String photo = HttpUtil.uploadFile(memberInfo.getPhoto());
						MemberRegisterActivity.this.setTitle("图片上传完毕！");
						memberInfo.setPhoto(photo);
					} else {
						memberInfo.setPhoto("upload/noimage.jpg");
					}
					/*调用业务逻辑层上传会员信息信息*/
					MemberRegisterActivity.this.setTitle("正在上传会员信息信息，稍等...");
					String result = memberInfoService.AddMemberInfo(memberInfo);
					Toast.makeText(getApplicationContext(), result, 1).show(); 
					/*操作完成后返回到会员信息管理界面*/ 
					Intent intent = new Intent();
					intent.setClass(MemberRegisterActivity.this,LoginActivity.class);
