...
public class ProductCartListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (username == null) {
			...
			setTitle("您好：" + username + "   当前位置---商品购物车列表");
		}
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑商品购物车信息
			...
			intent.putExtras(bundle);
			startActivity(intent);
			ProductCartListActivity.this.finish();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		menu.add(0, 1, 1, "添加商品购物车");
		menu.add(0, 2, 2, "查询商品购物车");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		if (item.getItemId() == 1) {
			...
			/*返回主界面*/
			Intent intent = new Intent();
			intent.setClass(ProductCartListActivity.this, MainMenuActivity.class);
			startActivity(intent);
			ProductCartListActivity.this.finish();
		}
		return true; 
